...
(:domain elevators-PIN)
    ...
    (:init 
        ...
        (= (battery-level fast0) 0.2)
        (= (battery-level fast1) 0.2)
        (= (battery-level slow10) 0.2)
        (= (battery-level slow20) 0.2)
        (= (battery-level slow21) 0.2)
        (= (battery-level slow30) 0.2)

        (= (battery-capacity fast0) 0.2)
        (= (battery-capacity fast1) 0.2)
        (= (battery-capacity slow10) 0.2)
        (= (battery-capacity slow20) 0.2)
        (= (battery-capacity slow21) 0.2)
        (= (battery-capacity slow30) 0.2)
